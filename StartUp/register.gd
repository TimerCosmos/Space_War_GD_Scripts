...
@onready var name_input = $VBoxContainer/UserNameInput
...
func _on_RegisterButton_pressed():
	...
	auth_service.register(email, name, password, _on_register_response)


func _on_register_response(code, response_text):
